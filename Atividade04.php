...
<body>
    <main>
        ...
        <div class="container">
        <h3>Atividade 04: <small class="text-body-secondary">Crie um formulário web que receba 2 notas, calcule a média dentre as notas e mostre se o aluno está aprovado ou reprovado. Considere a aprovação a nota maior ou igual a 7.</small>
        </h3>
        <form method="post">
          <div class="row">
          ...
          if (isset($_POST["media"])){
              ...
              if(media($v1, $v2)>=7){
                $mensagem = "Aluno aprovado, com média: " . media($v1, $v2);

                echo "<div class='alert alert-success' role='alert'>"
                      . $mensagem .
                      "</div>";
              } else {
                $mensagem = "Aluno reprovado, com média: " . media($v1, $v2);
