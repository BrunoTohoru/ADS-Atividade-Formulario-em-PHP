...
<body>
    <main>
        ...
        <div class="container">
        <h3>Atividade 07: <small class="text-body-secondary">Crie um formulário web que receba um número inteiro e mostre na tela de 1 até o número informado. Por exemplo:
          <br>Se o número informado for 4, mostre na tela: 1 2 3 4
          <br>Se o número informado for 7, mostre na tela: 1 2 3 4 5 6 7</small>
        </h3>
        <form method="post">
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="number" step="1" min=1 class="form-control" name="num" id="num" placeholder="" value="" required>
          ...
          if (isset($_POST["apresentar"])){
            ...
            while($x != $num){
              ...
              $mensagem = "O número escolhido foi ". $num . ": " . $mens . $num;
          ...
          ?>
          <hr class="mb-4">
          <button class="btn btn-primary btn-lg btn-block" name="apresentar" type="submit">Apresentar</button>
        </form>
      </div>
    </main>
</body>
