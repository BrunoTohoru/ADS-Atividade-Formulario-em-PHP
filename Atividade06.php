...
<body>
    <main>
        ...
        <div class="container">
        <h3>Atividade 06: <small class="text-body-secondary">Crie um formulário web que calcule o fatorial de um número recebido do usuário pelo formulário. Por exemplo:
          <br>Se o número informado for 5, o fatorial será: 5*4*3*2*1 = 120.</small>
        </h3>
        <form method="post">
          <div class="row">
            
            <div class="col-md-6 mb-3">
              <label for="num">Fatorial do número:</label>
              <input type="number" step="1" class="form-control" name="num" id="num" placeholder="" value="" required>
          ...
          if (isset($_POST["fatorial"])){
              ...
              $mensagem = "O fatorial de ". $num . " é : " . fatorial($num);
          ...
          ?>
          <hr class="mb-4">
          <button class="btn btn-primary btn-lg btn-block" name="fatorial" type="submit">Fatorar</button>
        </form>
      </div>
    </main>
</body>
