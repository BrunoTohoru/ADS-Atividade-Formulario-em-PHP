...
<body>
    <main>
        ...
        <div class="container">
        <h3>Atividade 03: <small class="text-body-secondary">Crie um formulário web para receber do usuário o raio e a altura de uma lata de óleo e calcule o seu volume utilizando a fórmula:<br>V = 3.14159 * R2* h</small>
        </h3>
        <form method="post">
          <div class="row">
            
            <div class="col-md-6 mb-3">
              <label for="valor1">Raio (em cm)</label>
              <input type="number" step="0.1" class="form-control" name="valor1" id="valor1" placeholder="" value="" required>
            ...
            <div class="col-md-6 mb-3">
              <label for="valor2">Altura (em cm)</label>
              <input type="number" step="0.1" class="form-control" name="valor2" id="valor2" placeholder="" value="" required>
              <div class="invalid-feedback">
                É obrigatório inserir um valor válido.
              </div>
            </div>
          ...
          ?>
          <hr class="mb-4">
          <button class="btn btn-primary btn-lg btn-block" name="calcular" type="submit">Calcular</button>
        </form>
      </div>
    </main>
</body>
