...
<body>
    <main>
        ...
        <div class="container">
        <h3>Atividade 02: <small class="text-body-secondary">Crie um formulário web que receba 4 notas, calcule a média dentre as notas e retorne o valor da média.</small>
        </h3>
        <form method="post">
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              <label for="valor4">4ª nota</label>
              <input type="number" step="0.1" min=0 max=10 class="form-control" name="valor4" id="valor4" placeholder="" value="" required>
              <div class="invalid-feedback">
                É obrigatório inserir um valor válido.
              </div>
            </div>
          ...
          if (isset($_POST["media"])){
              ...
              if(media($v1, $v2, $v3, $v4)>=6){
                $mensagem = "Aluno aprovado, com média: " . media($v1, $v2, $v3, $v4);

                echo "<div class='alert alert-success' role='alert'>"
                      . $mensagem .
                      "</div>";
              } else {
                $mensagem = "Aluno reprovado, com média: " . media($v1, $v2, $v3, $v4);
